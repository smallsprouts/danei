                ...
                <div class="box box-primary">
                  <div class="box-body">
                    <table id="my_order" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <td>657</td>
                        <td><span class="label bg-yellow">待处理</span></td>
                        <td>2014-11-7 11:31</td>
                        <td>￥50.00</td>
                        <td><a href="order-detail.html">查看</a>丨<a href="order-process.html">处理</a></td>
                      </tr>
                      <tr>
                        <td>183</td>
                        <td><span class="label bg-aqua">处理中<span></td>
                        <td>2014-11-7 11:31</td>
                        <td>￥25.99</td>
                        <td><a href="#">查看</a>丨<a href="#">处理</a></td>
                      </tr>
                      <tr>
                        <td>175</td>
                        <td><span class="label bg-green">已发货</span></td>
                        <td>2014-11-7 11:31</td>
                        <td>￥64.50</td>
                        <td><a href="#">查看</a>丨<a href="#">处理</a></td>
                      </tr>
                      <tr>
                        <td>219</td>
                        <td><span class="label bg-red">已交付</span></td>
                        <td>2014-11-7 11:31</td>
                        <td>￥10.70</td>
                        <td><a href="#">查看</a>丨处理</td>
                      </tr>
                      <tr>
                        <td>657</td>
                        <td><span class="label bg-yellow">待处理</span></td>
